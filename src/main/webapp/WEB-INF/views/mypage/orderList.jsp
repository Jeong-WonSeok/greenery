...
<div class="order-list">
	...
	<c:forEach items="${orderList}" var="detail">
		<div class="order-item-col">
			<div class="ol-1">${detail.createdAt}</div>
			<div class="ol-3">
				<div class="order-item-img">
					<img src="${pageContext.request.contextPath}/imageDown?productId=${detail.productId}&usecase=1" alt="${product.productName}" class="order-img">
				</div>
