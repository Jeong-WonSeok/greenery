			            ...
			            <div class="modal-content">
			                ...
			                <div class="modal-body">
			                    <div class="product-container">
			                        <img src="${pageContext.request.contextPath}/imageDown?productId=${detail.productId}&usecase=1" alt="" id="review_img">
			                        <div class="product-label">
			                            <div class="product-name"><span><strong>${detail.productName}</strong></span></div>
			                            <div class="product-description"><span>${detail.summaryDescription }</span></div>
			                        </div>
			                    </div>
...
*반품, 환불 관련 내용은 고객센터로 별도 문의해주세요."></textarea>
			                ...
			                <div class="modal-footer">
			                    ...
			                    <button type="button" class="btn write-btn" data-productid="${detail.productId}" data-orderid="${detail.orderId }">리뷰 등록하기</button>
			                </div>
