...
<body>
	...
	<div class="mypage">
		<div class="mypage-sidebar">
			...
			<span class="mypage-menu" data-url="mypage/likedProducts">찜한 상품</span>
			<span class="mypage-menu" data-url="mypage/orderList">주문 내역</span>
			<span class="mypage-menu" data-url="mypage/editMyInfo">개인정보 수정</span>
		</div>
