...
<body>
	...
	<form class="form-signup" name="formSignup" action="/user/signup"
		method="post">

		<div class="form-id">
			<input id="inputId" name="greeneryId" class="input input1"
		...
		<input id="inputPassword1" name="password" class="input input2"
		...
		<input id="inputName" name="name" class="input input4" type="text"
			placeholder="이름을 입력해주세요." required>
		<div id="inputNameMessage"></div>
		<input id="inputPhone" name="phone" class="input input5" type="text"
			placeholder="휴대폰 번호 입력('-'제외 11자리 입력)" required>
		<div id="inputPhoneMessage"></div>

		<div class="form-email">
			<input id="inputEmailAddress" name="emailAddress"
		...
		<div class="form-address">
			<input class="input input8" type="text" name="zipcode"
				placeholder="우편번호" required>
			<button id="btnZipcode" class="btn btn2" type="button">우편번호
				찾기</button>
		</div>

		<input class="input input9" name="address1" type="text"
			placeholder="도로명 주소" required> 
		<input class="input input10"
			name="address2" type="text" placeholder="상세 주소" required> <input
			class="btn btn3" type="submit" value="회원가입">
	</form>


	<script
		src="${pageContext.request.contextPath}/resources/js/user/signup.js"></script>
</body>
