    ...
    <div>
            ...
            <form>
                <div class="form-group">
                    ...
                    <input id="product-name" type="text" placeholder="예시) 프레시 블랙 떡솝" maxlength="250">
                    <div id="charCount">0 / 250</div>
                </div>
                <div class="form-group">
                    <label>판매가<span class="text-essential">(필수)</span></label>
                    <input type="text" placeholder="가격을 입력해주세요" maxlength="10">
                ...
                <div class="image-thumnail">
                    ...
                    <div class="image-upload-container">
                        ...
                        <input type="file" id="image-input1" accept="image/*" style="display: none;"
                        ...
                        <input type="file" id="image-input3" accept="image/*" style="display: none;"
                        ...
                        <input type="file" id="image-input4" accept="image/*" style="display: none;"
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="상품의 대표 설명을 입력하세요">
                </div>
                <div class="form-group">
                    <label>상품 상세페이지 대표 설명</label>
                    <input type="text" placeholder="상품의 핵심 특징을 간단히 설명하세요">
                </div>
                <div class="image-thumnail">
                    ...
                    <input type="file" id="image-input5" accept="image/*" style="display: none;"
